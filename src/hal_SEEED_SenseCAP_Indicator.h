...
// ── SPI-Pins für SX1262 (direkt am ESP32-S3, geteilt mit Display-Init-SPI) ──
#define LORA_SCK    41
#define LORA_MISO   47
#define LORA_MOSI   48

// ── PCA9535 I2C-Expander (0x20): steuert Display + LoRa-Kontrollpins ─────────
...
// Virtuelle Pin-Nummern für RadioLib-HAL (→ PCA9535-Bits)
#define LORA_NSS    200   // → PCA9535 bit 0 (CS)
#define LORA_RST    201   // → PCA9535 bit 1 (RST)
#define LORA_BUSY   202   // → PCA9535 bit 2 (BUSY, Eingang)
#define LORA_DIO1   203   // → PCA9535 bit 3 (DIO1, Eingang)

// Display RGB interface
#define LCD_BL_PIN          45         // backlight (active high, via GPIO)
#define PIN_AP_MODE_SWITCH  0          // BOOT button (nicht genutzt, RP2040 zieht low)
